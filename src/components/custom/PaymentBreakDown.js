...
const PaymentBreakDown = ({
  ...
  // Use getSelectedCard if available; otherwise fallback to firstCardData
  const activeCard = getSelectedCard || firstCardData;

  // Safe fallbacks for undefined values
  const last4Digits = activeCard?.last4 || "XXXX";
  ...
  const expMonth = activeCard?.exp_month || activeCard?.expiryMonth;
  const expYear = activeCard?.exp_year || activeCard?.expiryYear;
  const expiryDate =
    expMonth && expYear ? `${expMonth}/${expYear}` : "MM/YY";
      ...
      <div style={styles.modalCard}>
        ...
        <div style={styles.breakdownBox}>
          ...
          <div style={styles.infoRow}>
            ...
            <span style={styles.value}>{cardHolderName}</span>
          </div>
...
//   console.log(firstCardData, "first card data");
